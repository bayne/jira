...
func RegisterAllCommands() {
	...
	jiracli.RegisterCommand(jiracli.CommandRegistry{Command: "previous", Entry: CmdPreviousSprintRegistry(), Aliases: []string{"prev"}})
	...
	jiracli.RegisterCommand(jiracli.CommandRegistry{Command: "fv", Entry: CmdFixVersionSetRegistry()})
	...
	jiracli.RegisterCommand(jiracli.CommandRegistry{Command: "structure", Entry: CmdStructureRegistry()})
}
